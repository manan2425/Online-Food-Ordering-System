        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/food-mohalla.png" alt=""
                                            ...
                                            if (!mysqli_num_rows($query_res) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_array($query_res)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a href="#?order_id=<?php echo $row['o_id']; ?>&action=reorder" class="btn btn-success btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-repeat" style="font-size:16px"></i></a>
